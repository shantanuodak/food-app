...
const estimates: InventoryEstimate[] = [
  ...
  estimate('Potato shaak', ['potato shaak', 'potato sabzi', 'aloo sabzi'], 1, 'serving', 140, 190, 4, 30, 7),
  ...
  estimate('Jerk chicken', ['jerk chicken'], 1, 'serving', 160, 320, 35, 6, 16),
  estimate('Pickled mustard greens', ['pickled mustard greens', 'mustard greens'], 1, 'side', 45, 20, 1, 4, 0),
  estimate('Coconut broth', ['coconut broth'], 1, 'cup', 200, 220, 3, 8, 20),
  estimate('Bun bo hue', ['bun bo hue'], 1, 'bowl', 650, 780, 38, 75, 34),
  estimate('Beef', ['beef shank', 'beef strips'], 1, 'serving', 140, 300, 30, 0, 19),
  estimate('Pork sausage', ['pork sausage', 'minced pork'], 1, 'serving', 90, 280, 17, 2, 23),
  ...
  estimate('Lamb gyro', ['lamb gyro'], 1, 'serving', 180, 440, 26, 20, 28),
  ...
  estimate('Birria tacos', ['birria tacos'], 3, 'tacos', 360, 780, 36, 66, 38),
  estimate('Consome', ['consome'], 1, 'cup', 180, 90, 7, 4, 5),
  estimate('Oaxaca cheese', ['oaxaca cheese'], 1, 'oz', 28, 110, 7, 1, 9),
  estimate('Salsa verde', ['salsa verde'], 2, 'tbsp', 35, 20, 1, 4, 0),
  ...
  estimate('Side greens', ['side greens', 'kale caesar'], 1, 'side', 120, 90, 3, 10, 5),
  ...
  estimate('Smash burger', ['smash burger', 'double patty'], 1, 'burger', 260, 720, 38, 42, 44),
  estimate('Bacon jam', ['bacon jam'], 1, 'tbsp', 25, 100, 3, 10, 6),
  ...
  estimate('BBQ sauce', ['bbq sauce'], 2, 'tbsp', 35, 70, 0, 17, 0),
  ...
  estimate('Harissa potatoes', ['harissa potatoes'], 1, 'serving', 140, 200, 4, 34, 6),
  ...
  estimate('Basque cheesecake', ['basque cheesecake'], 1, 'slice', 140, 430, 8, 34, 29),
  ...
  estimate('Caramel popcorn', ['caramel popcorn'], 1, 'box', 120, 520, 5, 95, 14),
  estimate('Nachos', ['nachos'], 1, 'serving', 150, 450, 10, 50, 24),
  estimate('Cheese cup', ['cheese cup'], 1, 'cup', 70, 220, 8, 8, 18),
  estimate('Pretzel bites', ['mini pretzel bites', 'pretzel bites'], 1, 'serving', 120, 360, 10, 72, 4),
  estimate('Cola', ['cola'], 1, 'cup', 355, 140, 0, 39, 0),
  estimate('Roti', ['roti', 'chapati'], 1, 'piece', 45, 120, 3.5, 20, 3),
  estimate('Fried okra', ['fried okra'], 1, 'serving', 100, 180, 4, 20, 10),
  ...
  estimate('Rice and beans', ['rice and beans'], 1, 'serving', 220, 360, 12, 62, 6)
];
