...
function buildPrompt(draft: RecipeDraft): string {
  ...
  return [
    ...
    '4. Split instructions into discrete, ordered steps — one action per step.',
    '   If the input crams all steps into one paragraph, break it apart. DROP',
    '   step lines that are social CTAs, nav, ads, URLs, or hashtags.',
