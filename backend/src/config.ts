...
export const config = {
  ...
  aiImageHardRescueBudgetMs: integerWithDefault('AI_IMAGE_HARD_RESCUE_BUDGET_MS', 18_000),
  aiImageRescueTimeoutMs: integerWithDefault('AI_IMAGE_RESCUE_TIMEOUT_MS', 6_000),
