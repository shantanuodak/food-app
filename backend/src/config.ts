...
export const config = {
  ...
  offBaseUrl: process.env.OFF_BASE_URL || 'https://world.openfoodfacts.org/api/v2',
  offUserAgent: process.env.OFF_USER_AGENT || 'FoodApp/1.0 (contact@foodapp.com)',
  ...
  aiImageInventoryModel: process.env.AI_IMAGE_INVENTORY_MODEL || process.env.GEMINI_FLASH_MODEL || 'gemini-3-flash',
  aiImageLabelModel: process.env.AI_IMAGE_LABEL_MODEL || process.env.GEMINI_FLASH_LITE_MODEL || 'gemini-3.1-flash-lite',
  aiImageCaptionModel: process.env.AI_IMAGE_CAPTION_MODEL || process.env.GEMINI_FLASH_LITE_MODEL || 'gemini-3.1-flash-lite',
  aiImageInventoryThinking: process.env.AI_IMAGE_INVENTORY_THINKING || 'low',
  aiImageLabelThinking: process.env.AI_IMAGE_LABEL_THINKING || 'low',
  aiImageLaneRouterEnabled: booleanWithDefault('AI_IMAGE_LANE_ROUTER_ENABLED', true),
  ...
  aiImageProductBudgetMs: integerWithDefault('AI_IMAGE_PRODUCT_BUDGET_MS', 5_000),
  aiImageSimpleBudgetMs: integerWithDefault('AI_IMAGE_SIMPLE_BUDGET_MS', 6_000),
  aiImageMultiBudgetMs: integerWithDefault('AI_IMAGE_MULTI_BUDGET_MS', 12_000),
  aiImageHardRescueBudgetMs: integerWithDefault('AI_IMAGE_HARD_RESCUE_BUDGET_MS', 8_000),
  aiImageRescueTimeoutMs: integerWithDefault('AI_IMAGE_RESCUE_TIMEOUT_MS', 4_000),
