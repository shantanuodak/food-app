...
export const config = {
  ...
  geminiTimeoutMs: integerWithDefault('GEMINI_TIMEOUT_MS', 8_000),
  ...
  geminiCircuitBreakerConsecutive429: integerWithDefault('GEMINI_CIRCUIT_BREAKER_CONSECUTIVE_429', 2),
  geminiCircuitBreakerCooldownMs: integerWithDefault('GEMINI_CIRCUIT_BREAKER_COOLDOWN_MS', 60_000),
  fatsecretEnabled: booleanWithDefault('FATSECRET_ENABLED', true),
  ...
  fatsecretSearchMaxResults: integerWithDefault('FATSECRET_SEARCH_MAX_RESULTS', 8),
  fatsecretMinCoverage: numberWithDefault('FATSECRET_MIN_COVERAGE', 0.6),
  fatsecretMinConfidence: numberWithDefault('FATSECRET_MIN_CONFIDENCE', 0.72),
  fatsecretTimeoutMs: numberWithDefault('FATSECRET_TIMEOUT_MS', 8000),
  fatsecretDebugCandidates: process.env.FATSECRET_DEBUG_CANDIDATES === 'true',
  ...
  aiImagePrimaryModel: process.env.AI_IMAGE_PRIMARY_MODEL || process.env.GEMINI_FLASH_LITE_MODEL || 'gemini-2.5-flash-lite',
  ...
  parseCacheSchemaVersion: process.env.PARSE_CACHE_SCHEMA_VERSION || 'k3',
  parseVersion: process.env.PARSE_VERSION || 'v2',
  parseProviderRouteVersion: process.env.PARSE_PROVIDER_ROUTE_VERSION || 'r1',
  parsePromptVersion:
