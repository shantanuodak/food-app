...
// Wraps the always-on recipes peek `.sheet` so MainLoggingShellBody's view
// body stays under the SwiftUI type-checker threshold. Verified freeze-free
// on a clean build 2026-05-30 (a from-scratch sim launch sampled 0
// PollingRule frames and rendered the drawer with live recipe data) — the
// launch freeze chased earlier was a stale Xcode debug build, not this code.
