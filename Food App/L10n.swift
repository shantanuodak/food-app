...
enum L10n {
    ...
    static let onboardingSplashTitle = tr("onboarding.splash.title", "Log your food with\nless Effort")
    ...
    static let retryParseButton = tr("main.retry_parse.button", "Retry Parse")
    static let retryParseHint = tr("main.retry_parse.hint", "Retries nutrition parsing for the current text.")
    ...
    static let parseQueuedLabel = tr("main.parse.queued", "Finishing current parse. New rows are queued.")
    ...
    static let parseRateLimited = tr("main.error.parse_rate_limited", "Parsing is busy. Wait a few seconds and try again.")
